...
from .services.urteil_extractor import (
    ...
    extract_sexualdelikt_urteil_data, validate_sexualdelikt_extracted_data
)
...
class SexualdeliktUrteilAdminForm(forms.ModelForm):
    """Custom Admin Form mit KI-Assistenz für automatisches Ausfüllen von SexualdeliktUrteil."""
    ...
    class Media:
        js = ('admin/js/sexualdelikt_urteil_auto_fill.js',)
...
class SexualdeliktUrteilAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Deliktsangaben', {
            'fields': ('hauptdelikt', 'hauptdelikt_tatmittel', 'hauptdelikt_mehrfachbegehung',
                       'hauptdelikt_taeter_opfer_beziehung', 'hauptdelikt_opferalter',
                       'hauptdelikt_opfer_vorerfahrung', 'hauptdelikt_deliktsdauer_bekannt',
                       'hautpdelikt_deliktsdauer_einfachbegehung', 'hauptdelikt_mehrfachbegehung_anzahl',
                       'hauptdelikt_mehrfachbegehung_deliktsperiode', 'sexualdelikte_zusaetzliche',
    ...
    def get_urls(self):
        ...
        urls = super().get_urls()
        custom_urls = [
            path('auto-fill/', self.admin_site.admin_view(self.auto_fill_view), name='sexualdelikt-urteil-auto-fill'),
        ]
        return custom_urls + urls
    ...
    def auto_fill_view(self, request):
        ...
        try:
            ...
            # Daten extrahieren
            extracted_data = extract_sexualdelikt_urteil_data(volltext, pdf_url)

            # Validieren
            is_valid, errors = validate_sexualdelikt_extracted_data(extracted_data)
